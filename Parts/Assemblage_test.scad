...
translate([28,y_charriot+40,0])
rotate([270,-90,0])
import("glissieres/glissiere_v5.stl");
translate([440+20-28,largeur_charriot+y_charriot+40,0])
rotate([90,270,0])
import("glissieres/glissiere_v5.stl");
...
translate([10+18+12-10,y_charriot+50,20])
rotate([0,90,0])
cylinder(h = longueur_guide,
    d=axe_diam, center=false);
translate([10+18+12-10,y_charriot+90,20])
rotate([0,90,0])
cylinder(h = longueur_guide,
    d=axe_diam, center=false);
}
